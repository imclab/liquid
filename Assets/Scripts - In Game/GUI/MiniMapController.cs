...
public class MiniMapController : MonoBehaviour, IMiniMapController {
	...
	public void LoadMiniMap(out float guiWidth, out Rect miniMapRect) {
		...
		Ray ray2 = camera.ViewportPointToRay (new Vector3(1,1,0));
	...
	private void UpdateViewPort() {
		...
		m_ViewPortVectors[0] = camera.WorldToScreenPoint (v1);
		m_ViewPortVectors[1] = camera.WorldToScreenPoint (v3);
		m_ViewPortVectors[2] = camera.WorldToScreenPoint (v2);
		m_ViewPortVectors[3] = camera.WorldToScreenPoint (v4);
